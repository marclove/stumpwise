...
class HomeControllerTest < ActionController::TestCase
  context "on POST to :create_site" do
    ...
    context "and gateway successfully creates customer" do
      ...
      context "and gateway successfully creates subscription" do
        setup do
          Braintree::Subscription.expects(:create).returns(gateway_subscription_create_result(:success)).once
        end
          ...
          context "and valid site" do
            ...
            context "and valid administratorship" do
              setup do
                ...
                post :create_site, :invite_code => "pbsw1102", :site => Factory.attributes_for(:site), :user => Factory.attributes_for(:user), :credit_card => credit_card(:cardholder_name => "John Doe")
              end
              ...
              should "create the site with an initial status of inactive" do
              ...
              should "save the subscription id" do
                assert assigns(:site).subscription_id.present?
              end
              
              should "save the subscription billing cycle" do
                assert assigns(:site).subscription_billing_cycle.present?
              end
            end
      ...
      context "and gateway rejects subscription creation" do
        setup do
          Braintree::Subscription.expects(:create).returns(gateway_subscription_create_result(:error)).once
          post :create_site, :invite_code => "pbsw1102", :site => Factory.attributes_for(:site), :user => Factory.attributes_for(:user), :credit_card => credit_card(:cardholder_name => "John Doe")
        end
